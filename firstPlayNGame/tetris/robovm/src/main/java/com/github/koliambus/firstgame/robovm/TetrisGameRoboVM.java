package com.github.koliambus.firstgame.robovm;
...
public class TetrisGameRoboVM extends UIApplicationDelegateAdapter {
  ...
  public static void main (String[] args) {
    ...
    UIApplication.main(args, null, TetrisGameRoboVM.class);
    pool.close();
  }
}
